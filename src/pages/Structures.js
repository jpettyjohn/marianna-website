            ...
            <div className="structures-main-container">
                ...
                <div className="structures-wrapper">
                    <div className="structures-border">
                        <h1 className="secondary-title">Concrete Structures</h1>
                        <p style={{ textIndent: "2em" }}>
                            Why test concrete structures? Because concrete is
                            the most used structural material and thus very
                            important. All around us, bridges, buildings, roads
                        ...
                        <div className="structures-img-container">
                            ...
                            />{" "}
                            <div className="label">
                                Bridge deck with GFRP bars before concrete
                                casting
                            </div>
                        </div>
                    </div>
                    <div className="structures-border">
                        <h1 className="secondary-title">
                            Concrete Structures Reinforced with Fibre Reinforced
                            Plastic Bars.
                        </h1>
                        <p style={{ textIndent: "2em" }}>
                            Why test concrete structures? Because concrete is
                        ...
                        <p style={{ textIndent: "2em" }}>
                            ...
                            These are fibre reinforced polymer composite (FRP)
                            bars. They are strong, do not corrode but behave
                            differently than steel and must be researched
                            comprehensively. We have several projects on FRP
                            reinforced structural concrete. The most common FRP
                            concrete reinforcement are bars made from glass
                            fibre reinforced polymers – GFRP bars.
                        </p>
                    </div>
                    <div className="structures-border-alt">
                        <h1 className="secondary-title">
                            Structures Laboratory at the University of Waterloo
                        </h1>
                        <p style={{ textIndent: "2em" }}>
                        ...
                        <div className="structures-img-container">
                            ...
                            />{" "}
                            <div className="label">
                                Building reinforcing cages in the Laboratory
                            </div>
                        </div>
                        <div className="structures-img-container">
                            <img
                    ...
                    <div className="structures-border-alt">
                        ...
                        <p style={{ textIndent: "2em" }}>
                            ...
                            flexural and shear failures were investigated for
                            short and slender beams.
                        </p>
                        <div className="structures-img-container">
                            <img
                                className="structures-img"
                        ...
                        <div className="structures-img-container">
                            <img
                                ...
                                alt="Img 4"
                            />{" "}
                            <div className="label">Beams at failure</div>
                        </div>
                        <div className="structures-img-container">
                            <img
                                className="structures-img"
                    ...
                    <div className="structures-border-alt">
                        ...
                        <p style={{ textIndent: "2em" }}>
                            Frames are part of most structures. The connections
                            between columns and beams in frames must be strong
                            to withstand loads applied to the members. We have
                            been testing GFRP reinforced frames with different
                            reinforcement configurations. We also analyse these
                            joints with nonlinear finite element analysis
                        </p>
                        <div className="structures-img-container">
                            <img
                                className="structures-img"
                        ...
                        <div className="structures-img-container">
                            ...
                            />{" "}
                            <div className="label">
                                Corners under opening moments Spciment during
                                testing
                            </div>
                        </div>
                        <div className="structures-img-container">
                        ...
                        <div className="structures-img-container">
                            ...
                            />{" "}
                            <div className="label">
                                Corner under opening moments Crack pattern at
                                failure
                            </div>
                        </div>
                        <div className="structures-img-container">
                            ...
                            />{" "}
                            <div className="label">
                                Corners under closing moment- failure pattern
                            </div>
                        </div>
                        <div className="structures-img-container">
                            <img
                    ...
                    <div className="structures-border-alt">
                        ...
                        <p style={{ textIndent: "2em" }}>
                            There are many flat concrete slabs in our buildings.
                            We investigate the connections between the slabs and
                            the columns. Over the years we have tested many slab
                            specimens and investigated punching shear, shear
                            retrofit techniques which we developed, openings in
                            the slabs, and seismic behaviour. Our most recent
                            project is to test slabs with GFRP reinforcements
                            with steel fibres, and steel shear reinforcing
                        </p>
                        <div className="structures-img-container">
                            <img
                                className="structures-img"
                            ...
                            />{" "}
                            <div className="label">
                                Punching shear failure Wolverhampton, West
                                Midlands 1997
                            </div>
                        </div>
                        <div className="structures-img-container">
                            ...
                            />{" "}
                            <div className="label">
                                Setup for testing flat slabs for punching shear
                            </div>
                        </div>
                        <div className="structures-img-container">
                            <img
                            ...
                            />{" "}
                            <div className="label">
                                Retrofit of concrete slabs with shear bolts
                            </div>
                        </div>
                        <div className="structures-img-container">
                            <img
                            ...
                            />{" "}
                            <div className="label">
                                Shear bolts installed in a real building
                    ...
                    <div className="structures-border-alt">
                        ...
                        <p style={{ textIndent: "2em" }}>
                            We model structures using nonlinear finite element
                            analysis. Laboratory experiments are important but
                            testing requires building large specimens/samples
                            and we can only do few tests. This is where
                            nonlinear finite element analysis comes into play.
                            We first calibrate numerical models based on
                            laboratory testing. Then we run many analyses, for
                            many different parameters and we get a comprehensive
                            information on the behaviour of structures.
                        </p>
                        <div className="structures-img-container">
                            <img
                                className="structures-img"
                        ...
                        <div className="structures-img-container">
                            ...
                            />{" "}
                            <div className="label">
                                Modelling of shear reinforcement in concrete
                                slabs
                            </div>
                        </div>
                        <div className="structures-img-container">
                            ...
                            />{" "}
                            <div className="label">
                                Failure of GFRP reinforced concrete beams
                                without stirrups
                            </div>
                        </div>
                        <div className="structures-img-container">
                            ...
                            />{" "}
                            <div className="label">
                                Failure of GFRP reinforced concrete beams with
                                stirrups
                            </div>
                        </div>
                        <div className="structures-img-container">
